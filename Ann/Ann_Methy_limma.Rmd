...
## color bar on the top is for Units 
heatmap.2(SamplesCor, Rowv=dd, Colv=dd, col=color.palette, trace="none", ColSideColors=ColSideColors, na.color="grey50",labRow=sampleNum,  labCol=sampleNum, main="Correlation")
